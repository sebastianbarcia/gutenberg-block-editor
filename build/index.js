...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('ka-example-block/ka-example-container-block', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('KA Container block', 'ka-example-block'),
  category: 'design',
  edit({
    className
  }) {
...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Link Settings", "ka-example-block"),
    initialOpen: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelRow, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("fieldset", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Add link label", "ka-example-block")
    ...
    value: content,
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Write your text...", "my-affiliate-block"),
    style: {
      textAlign: align,
      backgroundColor: backgroundColor,
      color: textColor
...
/* harmony import */ var _container__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./container */ "./src/container.js");
/**
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/boton-bloque","version":"0.1.0","title":"Boton Bloque","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"boton-bloque","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","attributes":{"content":{"type":"string","source":"html","selector":"p"},"align":{"type":"string","default":"none"},"backgroundColor":{"type":"string"},"textColor":{"type":"string"},"kaLink":{"type":"string","default":""},"linkLabel":{"type":"string","default":"Check it out!"},"hasLinkNofollow":{"type":"boolean","default":false}},"styles":[{"name":"default","label":"Default","isDefault":true},{"name":"border","label":"Border"},{"name":"color-red","label":"ColorRed"}],"keywords":["bloque","boton","click"]}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkboton_bloque"] = globalThis["webpackChunkboton_bloque"] || [];
